      ...
      <div className="max-w-4xl mx-auto text-center">
        ...
        <div className="mb-12">
          <div className="relative">
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <AlertTriangle className="w-16 h-16 text-[#ccfd7f] animate-pulse" />
            </div>
          </div>
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">
            Page Not Found
          </h2>
          <div className="w-20 h-1 bg-[#ccfd7f] mx-auto rounded-full mb-6"></div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
          ...
          >
            <div className="text-center">
              <div className="w-16 h-16 bg-[#ccfd7f] rounded-xl flex items-center justify-center mx-auto mb-4 transition-transform duration-300 group-hover:scale-110">
        ...
        <div className="mt-12 text-center">
          <p className="text-gray-400 text-sm">
            ...
            <Link href="/contact" className="text-[#ccfd7f] hover:text-[#b8e85c] transition-colors ml-1">
              Contact us
            </Link>
          </p>
        </div>
